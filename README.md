...
:exclamation:**Not maintained anymore**:exclamation:: This gem is not maintained anymore and will receive no updates. @ngudbhav stepped in as a new maintainer and forked the gem (see #20). **Please use his fork https://github.com/ngudbhav/pronto-npm-eslint for a maintained version**.
